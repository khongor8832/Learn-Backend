...
BookSchema.virtual("zohiogch").get(function () {
  return "Amaraa"; // mongoose virtuals нэмж өгч байна.
});
BookSchema.virtual("First name ").get(function () {
  if (!this.author) return "";
  let tokens = this.author.split(" "); // Зохиогчын нэрийг зай, цэг, уртаар, хэрэв урт нь 1 байвал гээд шалгаж response-д хэвлэж байна
